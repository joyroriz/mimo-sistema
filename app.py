...
def carregar_dados_reais():
    ...
    try:
        ...
        arquivo_path = r'c:\Users\USER2\Documents\GitHub\mimo-sistema\Controle_MIMO_conteudo_completo.txt'

        with open(arquivo_path, 'r', encoding='utf-8') as file:
            linhas = file.readlines()

        print("📁 Carregando dados reais do arquivo MIMO...")

        # Processar produtos primeiro
        print("📦 Processando produtos...")
        produtos_inseridos = 0

        # Dados de produtos reais extraídos do arquivo
        produtos_reais = [
